...
import 'package:platzi_flutter/components/floatin_action_button.dart';
...
class CardImageProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: [
        card,
        FloatinActionButtonGreen()//Mandamos llamar nuestro metodo que viene de la clase exportada floating_action_button_green
      ],
    );
  }
